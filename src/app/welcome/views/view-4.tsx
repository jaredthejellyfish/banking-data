...
import TestPlaidButton from '@/components/test-plaid-button';
  ...
  return (
    <>
      <div className="md:max-w-[50%] flex flex-col gap-y-4 w-full">
        <h1 className="text-4xl font-bold bg-gradient-to-br from-[#8f00b3] to-[#FF6600] bg-clip-text text-transparent">
          {isSuccess ? 'All Done!' : 'Test Plaid Connection'}
        </h1>

        <p className="text-lg">
          {isSuccess
            ? 'You have successfully connected your bank account to App Name. You can now start using the app to route your transactions and manage your finances. Enjoy! 🎉'
            : ' Click the button below to test your Plaid connection. This will verify your access token and ability to pull transactions securely.'}
        </p>
        <TestPlaidButton setIsSuccess={setIsSuccess} />
      </div>
